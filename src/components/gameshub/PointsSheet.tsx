...
const styles = StyleSheet.create({
  ...
  heroValue: { fontFamily: ghFont.sans800, fontSize: 46, letterSpacing: -2, color: ghColor.sheetTextPrimary },
  ...
  deltaGlyph: { fontSize: 8, color: ghColor.sheetAccentOnLight },
  deltaLabel: { fontFamily: ghFont.mono500, fontSize: 10.5, color: ghColor.sheetAccentOnLight },
  tilesRow: { flexDirection: 'row', gap: 9, marginTop: 14 },
  tile: { flex: 1, borderRadius: 18, padding: 13, borderWidth: 1, borderColor: ghColor.sheetRowBorder },
  tileLabel: { fontFamily: ghFont.mono500, fontSize: 8.5, letterSpacing: 8.5 * 0.12, color: ghColor.sheetTextSecondary },
  tileValue: { fontFamily: ghFont.sans800, fontSize: 24, letterSpacing: -1, color: ghColor.sheetTextPrimary, marginTop: 8 },
  tileSub: { fontFamily: ghFont.sans400, fontSize: 10, color: ghColor.sheetTextSecondary, marginTop: 6 },
  eyebrow: { fontFamily: ghFont.mono500, fontSize: 9.5, letterSpacing: 9.5 * 0.14, color: ghColor.sheetTextTertiary, marginTop: 18, marginBottom: 9 },
  list: { maxHeight: 280 },
  listContent: { gap: 5, paddingBottom: 2 },
  emptyText: { fontFamily: ghFont.sans400, fontSize: 13, color: ghColor.sheetTextTertiary, textAlign: 'center', paddingVertical: 12 },
  txRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 11,
  ...
  txMid: { flex: 1 },
  txTitle: { fontFamily: ghFont.sans700, fontSize: 12.5, color: ghColor.sheetTextPrimary },
  txTime: { fontFamily: ghFont.mono500, fontSize: 9.5, color: ghColor.sheetTextTertiary, marginTop: 4 },
  txChange: { fontFamily: ghFont.mono500, fontSize: 13, color: ghColor.sheetAccentOnLight },
  txChangeNegative: { color: ghColor.sheetDanger },
